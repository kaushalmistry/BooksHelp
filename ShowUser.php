<?php
  ...
  if(!isset($_SESSION['userid'])){
    header("location:BookTransaction/ClearBook.php");
  }
...
<html>
<head>
    <title>BooksHelp | User Profile</title>
...
<body>
  ...
  <div class="profile">
      <?php
            ...
            if ($rnum->num_rows > 0) {
                while($row = $rnum->fetch_assoc()){
                    ...
                    echo "<div style='text-align:center;margin:50px;'>
                          <form action='Chat/chat_home.php' method='POST'>
            ...
            echo "<h2 style='text-align: center; padding:30px 0px;'>Other Books Uploaded By The User </h2>";
            $sql1 = "SELECT * from books INNER JOIN department ON books.dept = department.did where books.want_to_buy=0 AND books.uid='".$user_id."'";
            ...
            if($rnum->num_rows > 0){
              ...
              echo "<h4 class='text-center'>The books uploaded by the user are shown here.</h4>";
              echo "<h4 class='text-center'>Currently the user has not uploaded any books.</h4>";
            }
